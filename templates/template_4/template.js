...
function addContentPage(pptx, content,index) {
    ...
    slide.addText('0' + index,{ x: 0.5, y: "35%", w: "90%", h: "20%", fontSize: 36, align: "center" });
    slide.addText(content,{ x: 0.5, y: "45%", w: "90%", h: "20%", fontSize: 36, align: "center" });
} 
...
function template(body) {
    ...
    pptx.defineSlideMaster({
        title: "initial",
        background: { path: "images/Title/4.jpg" }
    });

    pptx.defineSlideMaster({
        title: "MASTER_SLIDE",
        background: { path: "images/Page/4.jpg" },
        objects: [
        ],
    });
    ...
    pptx.defineSlideMaster({
        title: "CONTENT_SLIDE",
        background: { path: "./images/content_page/4.jpg" },
    });

    pptx.defineSlideMaster({
        title: "CONTENT_PAGE",
        background: { path: "./images/Content/4.jpg" },
    });
