...
function addInitial(pptx, initialTitle) {
    ...
    slide.addText(initialTitle, { x: 0.5, y: "35%", w: "90%", h: "20%", fontSize: 42, align: "center",color : "ff461f" });
    slide.addText("请输入内容", { x: 0.5, y: "55%", w: "90%", h: "20%", fontSize: 16, align: "center" });
}
...
function addContentPage(pptx, content,index) {
    ...
    slide.addText('0' + index,{ x: 0.5, y: "35%", w: "90%", h: "20%", fontSize: 45, align: "center" });
    slide.addText(content,{ x: 0.5, y: "52%", w: "90%", h: "20%", fontSize: 36, align: "center" });
} 
...
function template(body) {
    ...
    pptx.defineSlideMaster({
        title: "initial",
        background: { path: "images/Title/5.jpg" }
    });

    pptx.defineSlideMaster({
        title: "MASTER_SLIDE",
        background: { path: "images/Page/5.jpg" },
        objects: [
        ],
    });
    ...
    pptx.defineSlideMaster({
        title: "CONTENT_SLIDE",
        background: { path: "./images/content_page/5.jpg" },
    });

    pptx.defineSlideMaster({
        title: "CONTENT_PAGE",
        background: { path: "./images/Content/5.jpg" },
    });
