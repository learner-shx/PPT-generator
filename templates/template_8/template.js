...
function addInitial(pptx, initialTitle) {
    ...
    slide.addText(initialTitle, { x: 0.5, y: "55%", w: "90%", h: "20%", fontSize: 42, align: "center"});
    slide.addText("请输入内容", { x: 0.5, y: "65%", w: "90%", h: "20%", fontSize: 16, align: "center" });
}
...
function addContentPage(pptx, content,index) {
    ...
    slide.addText('0' + index,{ x: 0.5, y: "28%", w: "90%", h: "20%", fontSize: 45, align: "center" });
